...
export const API_URL = 'http://0453-1-54-213-121.ngrok.io/api/v1';
...
export const TYPES = [
    ...
    { name: 'Anime đang chiếu', slug: 'list-dang-chieu' },
    { name: 'Anime trọn bộ', slug: 'list-tron-bo' }
]

export const TOPS = [
    { name: 'Theo ngày', slug: 'day.html' },
    { name: 'Yêu thích', slug: 'voted.html' },
    { name: 'Theo tháng', slug: 'month.html' },
    { name: 'Theo mùa', slug: 'season.html' },
    { name: 'Theo năm', slug: 'year.html' }
]
